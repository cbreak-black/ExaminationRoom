...
\paragraph{}
While not strictly part of software design, the user interface design is never the less important.
...
\todo{How is a scene represented?}
\todo{Tell about scene contents}
